				...
				<td align="center" style="padding: 20px 20px 30px;">
					...
					<table width="350" cellpadding="0" cellspacing="0" border="0" class="table-responsive" style="background-color: #FFFCF0; border-radius: 3px; -webkit-box-shadow: 0px 1px 6px 0px rgba(0, 0, 0, 0.29); -moz-box-shadow: 0px 1px 6px 0px rgba(0, 0, 0, 0.29); box-shadow: 0px 1px 6px 0px rgba(0, 0, 0, 0.29); margin: 0 auto; padding: 20px 20px 30px;">
						<tr style="padding: 10px 0px 40px;">
							<td align="left">
								<img class="imagen-movil" src="http://charlenetas.com/webAssets/images/llave.png" alt="">
							</td>
							<td align="right">
						...
						<tr>
							<td colspan=2 style="color: #802684; font-size: 24px; padding: 30px 0px;">
								¡Recuperar contraseña!
							</td>
						</tr>
						<tr>
							<td colspan=2 style="color: #802684;">
								Hola <?=$user?> parece que has olvidado tu contraseña, da click en el botón para cambiarla por una nueva.
							</td>
						</tr>
						<tr>
							<td align="center" colspan=2 style="padding: 60px 0px 40px;">
								<a href="<?=$url?>" style="background-color: #498FE1; border-radius: 5px; color: #FFF; display: block; font-size: 20px; height: 43px; line-height: 43px; margin: 0 auto; padding: 0 20px; width: 78%;" class="link-responsive">Cambiar contraseña</a>
							</td>
						</tr>
						<tr>
