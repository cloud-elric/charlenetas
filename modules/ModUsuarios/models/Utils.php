...
class Utils {
	...
	public function sendBienvenida($email, $parametrosEmail) {
		// Envia el correo electronico
		return $this->sendEmail ( '@app/modules/ModUsuarios/email/layouts/bienvenida.html', '@app/modules/ModUsuarios/email/', 'no-reply@onex.mx', $email, '¡Bienvenido! Ya eres parte de la comunidad.', $parametrosEmail );
	}
	...
	public function sendRecuperarPassword($email, $parametrosEmail) {
		// Envia el correo electronico
		return $this->sendEmail ( '@app/modules/ModUsuarios/email/layouts/recuperar-password.html', '@app/modules/ModUsuarios/email/', 'no-reply@onex.mx', $email, 'Recuperar contrase�a.', $parametrosEmail );
	}
