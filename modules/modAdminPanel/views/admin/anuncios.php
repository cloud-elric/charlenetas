	...
	<div class="row" id="js-contenedor-tarjetas">
		<?php foreach($anuncios as $anuncio){ ?>
			<div class="col s12 m6 l4" id="card_anuncio_<?=$anuncio->id_anuncio?>">
				<div id="card_anuncio_url_<?=$anuncio->id_anuncio?>" class="card card-media" data-token="<?=$anuncio->id_anuncio?>" style="background-image: url(<?=Url::base()?>/uploads/imagenesAnuncios/<?= $anuncio->txt_imagen ?>)">
