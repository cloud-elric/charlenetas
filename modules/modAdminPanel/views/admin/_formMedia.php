...
?>
	...
	<div class='row'>
     ...
     <?= Html::submitButton('<span class="ladda-label">Crear</span>', ['id'=>'js-crear-submit', 'class'=>'btn btn-submit waves-effect waves-light ladda-button animated delay-3', 'name' => 'boton-media', 'data-style'=>'zoom-in'])?>
