...
?>
	...
	<div class='row'>
     ...
     <?= Html::submitButton($media->isNewRecord?'crear':'editar', ['id'=>$media->isNewRecord?'js-crear-submit':'js-editar-submit', 'class'=>'btn btn-submit waves-effect waves-light ladda-button animated delay-3', 'name' => 'boton-media', 'data-style'=>'zoom-in'])?>
