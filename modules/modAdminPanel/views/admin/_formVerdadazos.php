...
?>
	...
	<div class='row open'>
     ...
     <?= Html::submitButton($verdadazo->isNewRecord?'crear':'editar', ['id'=>$verdadazo->isNewRecord?'js-crear-submit':'js-editar-submit', 'class'=>'btn btn-submit waves-effect waves-light ladda-button animated delay-3', 'name' => 'boton-media', 'data-style'=>'zoom-in'])?>
